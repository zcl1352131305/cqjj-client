    ...
    // baseUrl = "http://127.0.0.1:8080";
        ...
        jQuery(function() {
            ...
            function addUploadedFile(file){
                ...
                var imgSrc='<img src="'+serverBasePath+file.fileUrl+'">';
                if(!isPic(file.fileName,file.fileUrl)){
                    imgSrc = "不能预览";
                }else{
                    if(file.fileUrl.indexOf("http") != -1){
                        imgSrc='<img src="'+file.fileUrl+'">';
                    }
                    else{
                        imgSrc='<img src="'+serverBasePath+file.fileUrl+'">';
                    }
            ...
            uploader.onUploadSuccess = function(file,obj){
                ...
                if(null != param.uploadSuccess){
                    param.uploadSuccess(file,obj);
                }
